...
export function WalletCard({ wallet, onEdit, onDelete }: WalletCardProps) {
  ...
  return (
    <div className="relative group p-5 rounded-2xl bg-white dark:bg-zinc-900/60 border border-zinc-200 dark:border-zinc-800/80 shadow-xs hover:border-zinc-300 dark:hover:border-zinc-700/80 transition-all duration-150 flex flex-col justify-between overflow-hidden">
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center gap-3 min-w-0">
          <div
            ...
            style={{
              backgroundColor: `${wallet.color || "#10b981"}15`,
          ...
          <div className="min-w-0">
            ...
            <span className="inline-block mt-0.5 text-[10px] font-medium px-2 py-0.5 rounded-full bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400">
      ...
      {/* Bottom row: Saldo (Solid monochrome typography) */}
