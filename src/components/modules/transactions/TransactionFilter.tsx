...
export function TransactionFilter({
  ...
  return (
    <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3 p-3.5 rounded-2xl bg-white dark:bg-zinc-900/60 border border-zinc-200 dark:border-zinc-800/80 shadow-xs">
      {/* Type Tabs */}
        ...
        {TYPE_OPTIONS.map(({ value, label }) => {
          ...
          return (
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-medium whitespace-nowrap transition-all duration-100 active:scale-[0.98] ${
                isSelected
      ...
      <div className="flex items-center gap-2">
        ...
        <select
          ...
          className="px-3 py-1.5 rounded-lg bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 text-xs text-zinc-800 dark:text-zinc-200 focus:outline-none focus:border-emerald-500 shrink-0"
        >
